...
- 🟠 **No registration gating — channel/message commands work before authentication completes.**
...
- ⚪ **Command errors are only logged server-side (`std::cerr`), not consistently surfaced to the client.**
